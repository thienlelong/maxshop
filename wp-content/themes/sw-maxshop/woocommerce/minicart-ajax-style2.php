...
<div class="top-form top-form-minicart minicart-product-style3 pull-right">
	<div class="top-minicart pull-right">
		<a class="cart-contents" href="<?php echo $woocommerce->cart->get_cart_url(); ?>" title="<?php _e('View your shopping cart', 'maxshop'); ?>"><?php echo '<span class="minicart-number">'.$woocommerce->cart->cart_contents_count.'</span>'; _e('item(s)', 'maxshop');?></a>
	</div>
